...
<div class="absolute top-6 left-6 z-50 flex flex-row items-center space-x-4 pl-1 pb-4">
    ...
    <span class="text-2xl font-bold transition-opacity duration-300 ease-in-out" class:opacity-0={!toggleControls} class:opacity-100={toggleControls}>Behovskartan</span>
</div>
